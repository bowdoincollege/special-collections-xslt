...
<xsl:stylesheet version="1.0" xmlns="http://www.w3.org/1999/xhtml" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ead="urn:isbn:1-931666-22-9" xmlns:xlink="http://www.w3.org/1999/xlink">
    <!--
        *******************************************************************
        * VERSION:          1.00                                          *
        *                   March 6, 2018                                 *
        ...
        <body>
            ...
            <main class="wrapper">
                <section class="container" id="main-content">
                    ...
                    <!-- Contents -->
                    <aside class="options" aria-label="Guide Options">
                        <ul class="list-unstyled d-flex flex-column flex-md-row justify-content-between">
                            <li>
                                <button aria-label="Expand All Sections" type="button" id="all-series" class="btn btn-info">
                                </button>
                            </li>
                            <li class="align-self-end">
                                <div class="markSearch">
                                    <label for="guide-search" class="sr-only">Search Guide</label>
                                    <input id="guide-search" type="search" placeholder="Search Guide" onfocus="searchAll()" />
                                    <span class="markSearchResults" />
                                    <div class="markSearchNav">
                                        <div>|&#160;&#160;
                                            <span class="fa fa-angle-down" data-search="next" aria-hidden="true">
                                                <span class="sr-only">Find next</span>
                                            </span>
                                            <span class="fa fa-angle-up" data-search="prev" aria-hidden="true">
                                                <span class="sr-only">Find previous</span>
                                            </span>
                                            <span role="button" data-search="clear">
                    ...
                    <div class="row">
                        <div class="col-md-12" role="tablist">
                         ...
                         -->
                            <div class="panel-group" role="presentation" aria-multiselectable="true">
    ...
    <xsl:template name="digitized">
        <div class="show-grid digitized row">
            <div class="col-md-5">
    ...
    <xsl:template name="panel">
        ...
        <div role="tab" class="panel panel-default {$class}">
    ...
    <xsl:template name="footer">
        ...
        <script type="text/javascript" src="/arch/libr/js/finding-aid.js?v=2.1"/>
        <!-- https://markjs.io/ Added for Carr Jan. 2019-->
        <script type="text/javascript" src="/arch/libr/js/vendors/jquery.mark.min.js"/>
        <script src="/arch/libr/js/vendors/mark_utilities.js?v=1.2"/>
    </xsl:template>
